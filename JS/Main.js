...
const pocao1 = new Pocao_1.Pocao('Poção de cura', 10, TiposENUMs_1.EfeitoPocao.CURA);
const pocao2 = new Pocao_1.Pocao('Poção de Forca', 10, TiposENUMs_1.EfeitoPocao.FORCA);
